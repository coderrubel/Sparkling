...
class sparkling_recent_posts extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array('classname' => 'sparkling_recent_posts', 'description' => esc_html__("Sparkling Recent Posts Widget", 'sparkling'));
        parent::__construct('sparkling_recent_posts', esc_html__('Sparkling Recent Posts Widget', 'sparkling'), $widget_ops);
    }
    ...
    function form($instance) {
        ...
        if (!isset($instance['title']))
            $instance['title'] = esc_html__('Recent Posts', 'sparkling');
